-- ============================================================
-- SQL de referencia: recargo manual personalizable
-- Fecha: 2026-05-11
-- ============================================================
--
-- Este archivo NO es una migration versionada. Es la versión nueva
-- de las 2 funciones SECURITY DEFINER (cerrar_venta y finalizar_pedido)
-- que Tomás aplica a mano en el SQL editor de Supabase Cloud, DESPUÉS
-- de aplicar la migration 20260511180000_agregar_recargo_manual.sql.
--
-- CAMBIOS RESPECTO DE LA VERSIÓN ANTERIOR (20260504020000):
-- 1. 2 parámetros nuevos: p_recargo_porcentaje_manual, p_recargo_motivo
-- 2. Mutex: prohibido aplicar ambos recargos en la misma venta
-- 3. Validación de rango: 0 <= manual <= 100
-- 4. Cálculo del total respeta prioridad:
--      recargo_iva_reducido > recargo_manual > sin recargo
-- 5. INSERT/UPDATE escribe las 2 columnas nuevas
-- ============================================================


-- ============================================================
-- 1. cerrar_venta (versión nueva)
-- ============================================================
...
BEGIN
  ...
  -- Mutex de recargos
  IF p_recargo_iva_reducido AND p_recargo_porcentaje_manual IS NOT NULL THEN
  ...
  -- Prioridad: recargo_iva_reducido > recargo_manual > sin recargo.
  IF p_recargo_iva_reducido THEN
...
-- ============================================================
-- 2. finalizar_pedido (versión nueva)
-- ============================================================
